...
<template>
    ...
    >
        <p class="xl:col-span-3 lg:col-span-2 col-span-1 bg-gray-50 p-2 border rounded-xl">{{ item.name }}</p>
        ...
        >
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm text-gray-500 dark:text-white">{{ stat.name }}</p>

                    <p class="text-2xl font-medium text-gray-900 dark:text-gray-200">{{ stat.count }}</p>
                </div>
