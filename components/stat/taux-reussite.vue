...
async function init() {
    ...
    setTimeout(() => {
        const libelleArray = ["Electroménager", "Vêtements", "Bijoux"];
        const nombreArray = [63, 20, 30];
...
<template>
    <div>
        <div class="bg-white rounded-lg border border-slate-200">
            <h1 class="p-4 text-xl font-bold">Catégorie de produit le plus acheté</h1>
            <apexchart type="donut" height="350" :options="options" :series="series" class="p-4"></apexchart>
        </div>
    </div>
</template>
