...
<template>
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <UCard v-for="zone in filteredZones" :key="zone.id">
                <div class="space-y-3">
                    ...
                    <p v-if="zone.description" class="text-sm text-gray-600">
                        {{ zone.description }}
                    </p>
                </div>
            </UCard>
        ...
        <UModal v-model="showModal">
            <UCard>
                ...
                <UForm :state="currentZone" :schema="deliveryZoneSchema" @submit="saveZone" class="space-y-4">
                    ...
                    <UFormGroup label="Nom de la zone" name="name" required>
                        <UInput v-model="currentZone.name" placeholder="Ex: Zone Nord" />
                    </UFormGroup>
