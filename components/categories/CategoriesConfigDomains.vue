    ...
    <div class="space-y-4">
                ...
                <div class="space-y-3">
                    <div class="flex justify-between items-start">
                        <div class="flex-1">
                            ...
                            <p v-if="domain.description" class="text-sm text-gray-600 mt-1">
                                {{ domain.description }}
                            </p>
                        </div>
        ...
        <UModal v-model="showModal">
            <UCard>
                ...
                <UForm :state="currentDomain" :schema="sellerDomainSchema" @submit="saveDomain" class="space-y-4">
                    <UFormGroup label="Domaine" name="domain" required>
                        <UInput
                    ...
                    <div class="flex justify-end gap-2">
                        ...
                        <UButton type="submit" :loading="domainStore.loading">
