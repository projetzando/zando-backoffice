...
<template>
  <div class="p-6">
    <h1 class="text-2xl font-bold mb-6">Test des vues Supabase</h1>
    
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <!-- Test products_with_price -->
      <div class="bg-white rounded-lg shadow p-6">
        <h2 class="text-lg font-semibold mb-4">Vue products_with_price</h2>
      ...
      <div class="bg-white rounded-lg shadow p-6">
        <h2 class="text-lg font-semibold mb-4">Vue cart_with_details</h2>
        <div v-if="currentCart.length === 0" class="text-gray-500">
        ...
        <div v-else>
          ...
          <div v-for="item in currentCart" :key="item.id" 
               class="border rounded p-3 mb-3">
    ...
    <div class="mt-6 p-4 bg-gray-100 rounded-lg">
      <h3 class="font-semibold mb-2">Instructions de test:</h3>
      <ol class="text-sm text-gray-600 space-y-1 list-decimal list-inside">
        ...
        <li>Les données doivent venir des vues <code>products_with_price</code> et <code>cart_with_details</code></li>
        <li>Vérifier que les champs calculés (display_price, available_stock, etc.) sont présents</li>
      </ol>
    </div>
  </div>
</template>