...
function getTrendIcon(growth: number): string {
  return growth >= 0 ? 'i-heroicons-arrow-trending-up' : 'i-heroicons-arrow-trending-down'
}
...
<template>
  <div class="space-y-6">
        ...
        <div>
          ...
          <div class="space-y-3">
            ...
            <div v-if="sellerInfo.is_verified !== undefined">
              <UBadge
                :color="sellerInfo.is_verified ? 'green' : 'orange'"
                variant="subtle"
              >
          ...
          >
            ...
            <div class="grid grid-cols-2 gap-3">
              <div class="bg-white rounded-lg p-3 shadow-sm">
                ...
                <p class="font-semibold text-gray-900">
                  {{ formatPrice(walletInfo.total_earned || 0) }}
                </p>
              </div>
              <div class="bg-white rounded-lg p-3 shadow-sm">
                <p class="text-xs text-gray-600">
                ...
                <p class="font-semibold text-gray-900">
                  {{ formatPrice(walletInfo.total_withdrawn || 0) }}
                </p>
              </div>
            </div>
            <UButton
    ...
    <UCard
      v-if="isSuperAdmin && walletStore.systemWallet"
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
            ...
            <div class="bg-white rounded-lg p-4 shadow-sm">
              ...
              <p class="text-xs text-gray-500 mt-1">
                {{ walletStore.systemWallet.currency || 'XAF' }}
              </p>
            </div>
            ...
            <div class="bg-white rounded-lg p-4 shadow-sm">
              ...
              <p class="text-2xl font-bold text-blue-600">
                {{
                  formatPrice(
                    (walletStore.systemWallet.balance || 0)
                      + (walletStore.systemWallet.locked_balance || 0),
                  )
                }}
              </p>
              <p class="text-xs text-gray-500 mt-1">
